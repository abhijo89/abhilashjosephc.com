...
makr_article_publish.short_description = 'Publish'
draft_article.short_description = 'Draft'
close_article_commentstatus.short_description = 'Close'
open_article_commentstatus.short_description = 'Open'
